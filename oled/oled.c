...
void OLED_ShowVI(uint8 x, uint8 y, uint32 num, uint8 size2)
{
...
void OLED_ShowString(uint8 x, uint8 y, char *chr, uint8 Char_Size)
{
    char j = 0;
    while (chr[j] != '\0')
    {
...
void OLED_Init(void)
{
    ...
    OLED_Clear();
    OLED_ShowString(1, 0, "attitude-ctrl", 2);
    OLED_ShowString(1, 3, "20240830 OvO", 1);
}
...
void OLED_Prepare(){
    OLED_Clear();
    OLED_ShowString(1, 0, "Ctrl-", 1);
    OLED_ShowString(1, 1, "parameters:", 1);
    OLED_ShowString(1, 3, " #Roll :", 1);
    OLED_ShowString(1, 4, " #Pitch:", 1);
    OLED_ShowString(1, 5, " -------------", 1);
    OLED_ShowString(1, 6, " #Move :", 1);
    OLED_ShowString(1, 7, " #Mode :", 1);
}
